export default function Trailer(){ 
    return( 
        <section className="relative overflow-x-clip w-full max-w-full"> 
            ...
            <img className="absolute hidden -bottom-25 -right-10 w-70 md:block md:w-100 md:-right-40 md:-bottom-30 lg:-bottom-20 lg:-right-32 -z-10" src="/Icons/Planet9.svg" alt="Cloud Shadow"/> 
        </section> 
