    ...
    return( 
        <section id="about" className="relative overflow-x-clip w-full max-w-full isolate"> 
            <section className="flex flex-col md:flex-row pt-10 pb-5 md:p-5 lg:p-22 gap-0 md:items-stretch"> 
                {/* About Hishot */}
                <div className=" rounded-2xl sm:rounded-3xl md:p-4 pb-0 md:bg-[var(--color-card)] md:flex-1 md:border-2 border-[#F9FEFE] md:shadow-[0_4px_4px_0_rgba(0,0,0,0.25)] md:border-r-0 inverted-radius-card md:-mr-1 text-left h-fit items-center">
