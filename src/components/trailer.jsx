export default function Trailer(){
    return(
        <section className="relative">
            <section className="flex flex-col md:flex-row md:p-22 gap-0 md:items-stretch">
                <div className=" rounded-2xl sm:rounded-3xl md:p-4 md:bg-card md:flex-1 md:border-2 border-[#F9FEFE] md:pb-20 md:shadow-[0_4px_4px_0_rgba(0,0,0,0.25)]">
                    ...
                    <p className="font-chivo text-blue-info text-sm lg:text-base bg-card p-4 border-t-2 border-[#F9FEFE] z-0 md:border-0">
                ...
                <div className="bg-card p-4 md:p-6 lg:p-10 -mt-4 w-full flex justify-center flex-col border-b-2 border-[#F9FEFE] md:flex-1 sm:mt-0 md:relative md:top-10 md:rounded-4xl md:border-2 pb-8 max-h-150 shadow-[0_4px_4px_0_rgba(0,0,0,0.25)]">
                    ...
                    {/* Masih dalam revisi */}
                    <iframe src="" frameborder="0" className="w-full border-2 border-blue-950 bg-white h-full"></iframe>
                </div>
            </section>
            <img src="/Mascot1.svg" alt="Mascot" />
        </section>
    );
}