    ...
    return( 
        <section id="about" className="relative overflow-x-clip w-full max-w-full isolate mb-12"> 
            <section className="flex flex-col md:flex-row pt-10 pb-10 md:p-10 lg:p-22 gap-0 md:items-stretch"> 
                ...
                <div className="bg-[var(--color-card)] p-4 md:p-6 lg:p-10 -mt-4 w-full flex justify-center flex-col border-b-2 border-[#F9FEFE] md:flex-1 sm:mt-0 md:relative md:top-10 md:rounded-[2.25rem] md:border-2 md:border-l-0 pb-8 shadow-[0_4px_0_0_rgba(0,0,0,0.25)] md:-ml-0.5 ">
                    <h2 className="font-[family:var(--font-days-one)] text-2xl lg:text-4xl text-white text-shadow-[0_1.8px_1.8px_rgba(0,0,0,0.25)] self-center bg-[#F8A819]/90 w-fit border-[1.8px] border-[#F9FEFE] pt-4 pb-4 pr-4 pl-4 rounded-2xl md:rounded-3xl -mb-8 z-10 shadow-[0_1.8px_1.8px_rgba(0,0,0,0.25)]">Trailer</h2>
                    {/* Masih dalam revisi */} 
            ...
            {/* Mascot */}
            <img 
            className="hidden absolute md:block md:bottom-[-1.25rem] md:left-[-0.5rem] lg:left-[1rem] md:w-[13rem]" 
            ...
            {/* Cloud Shadow */}
            <img 
            className="absolute bottom-[-6.25rem] left-[-2.5rem] w-[17.5rem] sm:w-[20rem] md:w-[32.5rem] md:left-[-5rem] md:bottom-[-7.5rem] lg:bottom-[-5rem] -z-10" 
