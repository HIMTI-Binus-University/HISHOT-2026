...
export default function SecureOpportunity(){  
  ...
  className="hover:scale-105 transition-all duration-300"
      ...
      <img className="absolute w-[30rem] -right-[20rem] -bottom-[4rem] md:w-[30rem] md:-right-[20rem] md:-bottom-[3rem] lg:w-[35rem] lg:-right-[18rem] lg:-bottom-[2rem] z-[2]" src="Cloud2_Shadow.svg" alt="Cloud Shadow"/>
