  ...
  return(
    <section className="relative overflow-x-clip w-full max-w-full">
      <div className="relative px-8 pt-2 pb-16 flex flex-col items-center gap-8">
        ...
        {/* CHANGED: Added relative z-40 to this flex block container to hoist it above the following Footer element layout stack */}
        <div className="relative z-40 flex flex-row items-center justify-center gap-7">
          
          {/* Dropdown Container Wrapper */}
          <div className="relative z-30 inline-block group">
            <h2 
            ...
            {/* Dropdown Content */}
            <div 
              className="absolute left-1/2 -translate-x-1/2 mt-0 pt-3 hidden group-hover:flex flex-col min-w-[200px] z-50"
            >
              <div 
