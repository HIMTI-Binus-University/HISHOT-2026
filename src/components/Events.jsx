                  ...
                  <div className="flex flex-col flex-1 w-full pt-0 lg:pt-4 min-w-0">
                    ...
                    <div className="hidden lg:flex flex-col w-full mt-12 mb-8 text-[#0F4A6D]">
                      <div className="flex items-start gap-4">
                        <img src="/StarInfo.svg" alt="Star" className="w-[30px] h-[40px] xl:w-[45.7px] xl:h-[63.17px] shrink-0 object-contain mt-1" />
                        <h3 className="text-[24px] xl:text-[36px] leading-[1.4]" style={{ fontFamily: "'Days One', sans-serif" }}>Location: BINUS @ Alam Sutra</h3>
                      </div>
            ...
            {activeTab === 'workshop' && (
              <div className="w-full flex flex-col gap-14 xl:gap-20">
                ...
                <div className="w-full flex flex-col px-1 md:px-6">
                  ...
                  {/* Bagian Judul */}
                  <div className="w-full max-w-[1525px] mx-auto px-2 xl:px-4 mb-4 lg:mb-6 overflow-visible">
                    <h2 className="text-[#FFFFFF] text-[32px] md:text-[36px] xl:text-[40px] font-normal leading-[1.2] tracking-[0.12em] whitespace-normal break-words [text-shadow:3px_3px_2px_rgba(0,0,0,0.3),_0px_0px_10px_var(--glow)] xl:[text-shadow:6px_6px_4.89px_rgba(0,0,0,0.3),_0px_0px_20.6px_var(--glow)]" 
                        style={{ fontFamily: "'Days One', sans-serif", WebkitTextStroke: '1px var(--glow)' }}>
                  ...
                  <div className="flex flex-col lg:flex-row justify-between items-start w-full max-w-[1525px] mx-auto gap-8 px-2 xl:px-4 text-[#0F4A6D] min-w-0">
                    ...
                    <div className="hidden lg:flex flex-col w-full lg:w-1/2 pt-4 pl-2 min-w-0">
                      <div className="flex items-start gap-4">
                        <img src="/StarInfo.svg" alt="Star" className="w-[45.7px] h-[63.17px] mt-1 shrink-0 object-contain" />
                        <h3 className="text-[36px] leading-[1.4]" style={{ fontFamily: "'Days One', sans-serif" }}>Location: Online Platform (via Zoom)</h3>
                      </div>
                      <div className="flex gap-[15px] xl:gap-[20px] pl-[50px] xl:pl-[59px] mt-6 xl:mt-8">
                        {['More info', 'Guidebook'].map((text) => (
                ...
                <div className="w-full flex flex-col px-1 md:px-6">
                  ...
                  <div className="flex flex-col lg:flex-row justify-between items-start w-full max-w-[1525px] mx-auto gap-8 px-2 xl:px-4 text-[#0F4A6D] min-w-0">
                    ...
                    <div className="hidden lg:flex flex-col w-full lg:w-1/2 pt-4 pl-2 min-w-0">
                      <div className="flex items-start gap-4">
                        <img src="/StarInfo.svg" alt="Star" className="w-[45.7px] h-[63.17px] mt-1 shrink-0 object-contain" />
                        <h3 className="text-[24px] xl:text-[36px] leading-[1.4]" style={{ fontFamily: "'Days One', sans-serif" }}>Location: Online Platform (via Zoom)</h3>
                      </div>
                      <div className="flex gap-[15px] xl:gap-[20px] pl-[50px] xl:pl-[59px] mt-6 xl:mt-8">
                        {['More info', 'Guidebook'].map((text) => (
                          <button key={text} className="w-[150px] xl:w-[209px] h-[50px] xl:h-[71px] rounded-[30px] xl:rounded-[40px] border-[3px] xl:border-[4px] border-[#F9FEFE] shadow-lg text-white text-[18px] xl:text-[24px] transition-all duration-200 hover:scale-110 active:scale-95 cursor-pointer" style={{ fontFamily: "'Days One', sans-serif", backgroundColor: currentTheme.color }}>{text}</button>
                  ...
                  <div className="w-full flex flex-col">
                    ...
                    <div className="flex flex-col lg:flex-row justify-between items-start w-full max-w-[1525px] mx-auto gap-8 lg:gap-8 px-2 xl:px-4 text-[#0F4A6D] min-w-0">
                      ...
                      <div className="flex flex-col w-full lg:w-1/2 pt-0 lg:pt-4 min-w-0">
                        ...
                        <div className="hidden lg:flex flex-col w-full mt-12 mb-8 text-[#0F4A6D]">
                          <div className="flex items-start gap-4">
                            <img src="/StarInfo.svg" alt="Star" className="w-[30px] h-[40px] xl:w-[45.7px] h-[63.17px] shrink-0 object-contain mt-1" />
                            <h3 className="text-[24px] xl:text-[36px] leading-[1.4]" style={{ fontFamily: "'Days One', sans-serif" }}>Location: Binus @ Alam Sutra</h3>
                          </div>
                          <div className="flex gap-[15px] xl:gap-[20px] pl-[50px] xl:pl-[59px] mt-6 xl:mt-8">
                            {['More info', 'Guidebook'].map((text) => (
                      ...
                      <div className="flex flex-col lg:flex-row justify-between items-start w-full max-w-[1525px] mx-auto gap-8 px-2 xl:px-4 text-[#0F4A6D] min-w-0">
                        ...
                        <div className="flex flex-col w-full lg:w-1/2 pt-0 lg:pt-4 min-w-0">
                          <div className="hidden lg:flex flex-col w-full mt-12 mb-8 text-[#0F4A6D]">
                            <div className="flex items-start gap-4">
                              <img src="/StarInfo.svg" alt="Star" className="w-[30px] h-[40px] xl:w-[45.7px] h-[63.17px] shrink-0 object-contain mt-1" />
                              <h3 className="text-[24px] xl:text-[36px] leading-[1.4]" style={{ fontFamily: "'Days One', sans-serif" }}>Location: Place Name + Details</h3>
                            </div>
                            <div className="flex gap-[15px] xl:gap-[20px] pl-[50px] xl:pl-[59px] mt-6 xl:mt-8">
                              {['More info', 'Guidebook'].map((text) => (
                                <button key={text} className="w-[150px] xl:w-[209px] h-[50px] xl:h-[71px] rounded-[30px] xl:rounded-[40px] border-[3px] xl:border-[4px] border-[#F9FEFE] shadow-lg text-white text-[18px] xl:text-[24px] transition-all duration-200 hover:scale-110 active:scale-95 cursor-pointer" style={{ fontFamily: "'Days One', sans-serif", backgroundColor: currentTheme.color }}>{text}</button>
