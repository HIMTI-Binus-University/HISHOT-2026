  ...
  return(
    <div className="relative px-8 py-16 flex flex-col items-center gap-8">
      <div 
        ...
        <h1 
          className="font-days-one text-center text-[60px] tracking-[0.12em] text-white leading-tight"
          style={{
      ...
      <div className="flex flex-row items-center justify-center gap-7">
        <h2 
          className="font-days-one text-center text-[36px] border-white border-[3px] rounded-[40px] px-7 py-2
